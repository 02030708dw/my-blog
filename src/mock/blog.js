  ...
  return Mock.mock({
    ...
    data: {
      ...
      [`rows|${query.limit}`]: [{
        ...
        "createDate": Number(Mock.Random.date("T")),
        "scanNumber|0-3000": 0,
        ...
        //   }
        // ],
        "thumb|1": [Mock.Random.image('300x250', '#f0f', '#fff', 'Random Image'), null],
      }]
    }
  })
})
  ...
  data: {
    ...
    "toc": [
      { name: '概述', anchor: 'article-md-title-1' },
      {
        ...
        "children": [
          { "name": "简简单单的判定", anchor: 'article-md-title-3' },
          { "name": "简简单单的交互规范", anchor: 'article-md-title-4' },
        ]
      },
